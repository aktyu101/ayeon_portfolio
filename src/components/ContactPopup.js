        ...
        createPortal(
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 left-0 size-full z-[999] bg-black"
              onClick={togglePopup}
            ></motion.div>
            {/* 팝업 */}
            <motion.div
              ...
              className="fixed top-1/2 left-1/2 bg-white rounded-lg p-4 text-black border-[1px] z-[9999]"
              style={{
                maxWidth: "400px",
                width: "80vw",
                height: "300px",
            ...
            >
              ...
              <div className="flex gap-y-[10px] flex-wrap flex-col">
                ...
                <p className="flex justify-between">
                  <span>kakaotalk</span>
                  <a
                    href="https://open.kakao.com/o/s6G8x8mg"
                    className="ml-10px"
                  >
                    open chatting
                  </a>
